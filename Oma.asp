    ...
    <div class="header">
      <div class="footer">
        <div class="body">
          ...
          <div class="content" >
		  <div class="album" >
		  <div class="album_pho" style ="background:url(Oma.jpg);" >
		  </div>
		  <form action="Oma.asp" method="post" width="100%">
		  <h1>OMAR FARHAT</h1>
		  <fieldset>
		...
		qry="insert into comment (username,comment,comment_date,user_id)values('"&Session("username")&"','"&com&"','"&now&"',8)"
		oConn.execute(qry)
		oConn.close
		end if
		%>
		...
		Set oConn = Server.CreateObject("ADODB.Connection")
		oConn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; Dbq=" & Server.MapPath("db.mdb"))
		qry="select * from comment where user_id=8"
