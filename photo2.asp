    ...
    <div class="header">
      <div class="footer">
        <div class="body">
          ...
          <div class="content">
		  <div class="album" >
		  <div class="album_pho" style ="background:url(biz3.jpg);" > 
		  <a class="album3" href="Oma.asp" > OMAR </a>
		  <a class="album3" href="Ase.asp" > ASEM </a></div>
          </div>
		  <form action="photo2.asp" method="post">
		...
		qry="insert into comment (username,comment,comment_date,user_id)values('"&Session("username")&"','"&com&"','"&now&"',7)"
		oConn.execute(qry)
		oConn.close
		end if
		%>
		...
		Set oConn = Server.CreateObject("ADODB.Connection")
		oConn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; Dbq=" & Server.MapPath("db.mdb"))
		qry="select * from comment where user_id=7"
