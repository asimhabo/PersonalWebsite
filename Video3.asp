    ...
    <div class="header">
      <div class="footer">
        <div class="body">
          ...
          <div class="content" >
		  <form action="Video3.asp" method="post">
		  <h1>Listen it you will be better:</h1>
		  <iframe width="480px" height="300px" frameborder="0" allowfullscreen="allowfullscreen" src="https://www.youtube.com/embed/HGN_slCYkus" scrolling="no"></iframe>
		  <fieldset>
		...
		qry="insert into comment (username,comment,comment_date,user_id)values('"&Session("username")&"','"&com&"','"&now&"',5)"
		oConn.execute(qry)
		oConn.close
		end if
		%>
		...
		Set oConn = Server.CreateObject("ADODB.Connection")
		oConn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; Dbq=" & Server.MapPath("db.mdb"))
		qry="select * from comment where user_id=5"
