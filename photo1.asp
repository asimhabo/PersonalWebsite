    ...
    <div class="header">
      <div class="footer">
        <div class="body">
          ...
          <div class="content">
		  <div class="album" >
		  <div class="album_pho" style ="background:url(biz1.jpg);" > 
		  <a class="album2" href="Ase.asp" > ASEM </a>
		  <a class="album2" href="Osm.asp" > OSMAN </a></div>
          </div>
		  <form action="photo1.asp" method="post">
		  
		  <fieldset>
		  <h1> Share your opinion </h1>
          <label for="bio">Write a comment to them : </label>
		...
		qry="insert into comment (username,comment,comment_date,user_id)values('"&Session("username")&"','"&com&"','"&now&"',6)"
		oConn.execute(qry)
		oConn.close
		end if
		%>
		...
		Set oConn = Server.CreateObject("ADODB.Connection")
		oConn.Open("DRIVER={Microsoft Access Driver (*.mdb)}; Dbq=" & Server.MapPath("db.mdb"))
		qry="select * from comment where user_id=6"
